...
-- --------------------------------------------------
-- Date Created: 11/26/2023 16:55:34
...
CREATE TABLE [dbo].[Image] (
    ...
    [releaseDate] datetime  NOT NULL,
    [apertureSize] bigint  NULL,
    [exposureTime] bigint  NULL,
    [whiteBalance] bigint  NULL,
...
INSERT INTO [dbo].[Category] ([name]) VALUES ('Naturaleza');
GO

INSERT INTO [dbo].[Category] ([name]) VALUES ('Religion');
GO
-- --------------------------------------------------
-- Script has ended
-- --------------------------------------------------